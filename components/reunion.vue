<template>
  <v-container>
    <v-layout class="main-hero" text-center wrap>
      <v-flex>
        <h1 class="headline"> <nuxt-link  :to="{path: '/'}"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24"><path d="M21 11L6.414 11 11.707 5.707 10.293 4.293 2.586 12 10.293 19.707 11.707 18.293 6.414 13 21 13z"/></svg> </nuxt-link>Vengo a una reunión</h1>
      </v-flex>
    </v-layout>
